...
public class SkuController {
	...
	@PostMapping("/sku")
	@ResponseBody
	public Result getgoodsDetail(@RequestBody HashMap<String, Object> map) {
		return ResultGenerator.genSuccessResult(skuService.getSkuProduct(map));
...
/*	//用size获取
	...
	@GetMapping("/skuSize")
	@ResponseBody
	public Result getgoodsDetails(@RequestParam String size) {
		return ResultGenerator.genSuccessResult(skuService.getProductDetailBySize(size));
